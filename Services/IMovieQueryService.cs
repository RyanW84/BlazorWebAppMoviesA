...
public interface IMovieQueryService
{
    ...
    Task<List<string>> GetTagsForMovieAsync(int movieId);
    Task<List<string>> GetAllTagsAsync();
    Task<List<WatchLogEntry>> GetWatchLogAsync(int movieId);
    Task<List<(int Year, int Month, int Count)>> GetWatchesByMonthAsync();
}
